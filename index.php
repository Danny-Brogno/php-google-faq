      ...
      <?php
        ...
        $googleDatabase = [
          ...
          [
            ...
            "answers" =>
              [
                  "<div class='answer'>The recent <span class='blue'><a href='#'>ruling by the Court of Justice of the European Union</a></span> has profound consequences for search engines in Europe. The court found that certain users have the right to ask search engines like Google to remove results for queries that include the person's name. To qualify, the results shown would need to be inadequate, irrelevant, no longer relevant, or excessive.</div>",
                  ...
                  "<div class='answer'>When you search for a name, you may see a notice that says that results may have been modified in accordance with data protection law in Europe. We’re showing this notice in Europe when a user searches for most names, not just pages that have been affected by a removal."
              ]
          ...
          foreach ($googleDatabase as $content) {
            ...
            foreach ($content as $answer ) {
              echo $answer[0] . "<br>" . $answer[1] . "<br>" . $answer[2] . "<br>" . $answer[3] . "<br>" . $answer[4];
            }
          }
